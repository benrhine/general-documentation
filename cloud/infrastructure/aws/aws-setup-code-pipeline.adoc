...
* link:../../../infrastructure-as-code/aws/aws-cf-create-codepipeline.adoc[CloudFormation: (AWS) Create CodePipeline]
* link:../../../infrastructure-as-code/serverless/sls-aws-create-codepipeline.adoc[Serverless: (AWS) Create CodePipeline]
* link:../../../infrastructure-as-code/terraform/tf-aws-create-codepipeline.adoc[Terraform: (AWS) Create CodePipeline]
* link:../../../infrastructure-as-code/comparison/compare-codepipeline.adoc[Compare: CodePipeline]
