...
link:../engineering/ops/infrastructure-as-code/serverless/sls.adoc[here],
...
link:../../engineering/how-to/aws-create-a-custom-domain.adoc[creating a custom domain] for the running lambda.
