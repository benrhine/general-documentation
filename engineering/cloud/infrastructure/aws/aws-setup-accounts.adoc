...
* you will then receive an email to set the password for the newly created account
* set the password
* sign in

[CAUTION]
All accounts setup at this point are `ROOT` accounts and should be treated accordingly.

== Setup IAM Identity Center

Setting up the Identity Center is one of the most important things that can be done when setting up a new account as this
will greatly simplify the sign-in process for all of your users. To see a create explainer of the process, see this
https://www.youtube.com/watch?v=_KhrGFV_Npw[YouTube].

* Enable IAM Identity Center

image:../images/aws-account-config-1.png[]

* Tell it yes this is the right region and enable

image:../images/aws-account-config-2.png[]

* You will be greated by this dashboard

image:../images/aws-account-config-3.png[]

* Go to users
* Create a user
* Create a permission set
** Just select a predefined one for now

image:../images/aws-account-config-4.png[]

* Go to AWS Accounts

image:../images/aws-account-config-5.png[]

* Select the user that was created

image:../images/aws-account-config-6.png[]

* Select the permissions that were granted

image:../images/aws-account-config-7.png[]

* Review and approve

image:../images/aws-account-config-8.png[]

* Navigate to the access portal to see all accounts granted access to via the created user

image:../images/aws-account-config-9.png[]
