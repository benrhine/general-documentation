...
See {sl-ops-link-003-003-001}[Create Approval Rules Template with CloudFormation or Serverless Framework]
...
[NOTE]
Pre-requisite: This requires the Aws Slackbot is installed - see link:../../../engineering/training/how-to/aws-configure-chatbot.adoc[How To: Configure Aws Chatbot]
...
[NOTE]
Pre-requisite: This requires the Aws Slackbot is installed - see {tl-how-to-link-005}[How To: Configure Aws Chatbot]
...
See {sl-ops-link-003-003-002}[Create Notification Rules with CloudFormation or Serverless Framework]
