...
you have completed all those steps please review link:../../../engineering/onboarding.adoc[Start Here: Onboarding].
endif::[]
// Renders correctly in AsciiDoc Deployment
ifdef::deploy[]
This assumes all other setup steps from the onboarding process have been completed at this point. If you are unsure if
you have completed all those steps please review {sl-onboarding-link}[Start Here: Onboarding].
endif::[]
...
// Renders correctly in IDE
ifndef::deploy[]
For some example usages of the Aws CLI please see link:../../../engineering/tooling/tooling-cloud-aws/tooling-aws-cli.adoc[CLI: Usage]
endif::[]
// Renders correctly in AsciiDoc Deployment
ifdef::deploy[]
For some example usages of the Aws CLI please see {tl-tooling-link-022-004}[CLI: Usage]
endif::[]
...
ifndef::deploy[]
[NOTE]
This assumes you have fully completed the link:../../../engineering/onboarding.adoc[Start Here: Onboarding / Setup].

endif::[]
// Renders correctly in AsciiDoc Deployment
ifdef::deploy[]
[NOTE]
This assumes you have fully completed the {l-onboarding-link}[Start Here: Onboarding / Setup].
...
* https://docs.aws.amazon.com/singlesignon/latest/userguide/set-up-single-sign-on-access-to-accounts.html this one was important
...
* https://forum.serverless.com/t/use-aws-sso-on-sls/11521/21
* Serverless really really wants the creds in the .aws/credentials file
