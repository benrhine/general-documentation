...
link:../infrastructure-as-code/serverless/sls.adoc[here],
link:../infrastructure-as-code/serverless/sls-step-1-domain-deploy.adoc[Step 1],
link:../infrastructure-as-code/serverless/sls-step-2-app-resource-deploy.adoc[Step 2],
link:../infrastructure-as-code/serverless/sls-step-3-application-deploy.adoc[Step 3]) but there are some some differences.
...
link:../infrastructure-as-code/serverless/sls-step-1-domain-deploy.adoc[here], EXCEPT that it also applies a bucket
...
link:../infrastructure-as-code/serverless/sls-step-2-app-resource-deploy.adoc[here], this step is broken up somewhat differently.
...
link:../how-to/aws-create-a-custom-domain.adoc[creating a custom domain] for the running lambda.
...
link:../infrastructure-as-code/serverless/sls-step-3-application-deploy.adoc[here] but has been modified to add in a custom
